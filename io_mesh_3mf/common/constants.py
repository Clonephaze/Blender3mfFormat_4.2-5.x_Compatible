...
"""
3MF file format constants.

These are the constants inherent to the 3MF file format: XML namespaces,
file locations, MIME types, and relationship types.
"""
...
# Import limits.
# Maximum number of entries in a single basematerials or colorgroup resource.
# 3D scans (e.g. kinetic scans) can produce colorgroups with 50,000+ per-vertex
# colors.  Blender cannot create that many individual materials without hanging,
# so we cap and report to the user.
MAX_MATERIAL_GROUP_SIZE: int = 1000
